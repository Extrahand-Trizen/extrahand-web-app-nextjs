...
const mockTaskData = {
   ...
   budget: "₹1500",
   description:
      "Complete deep cleaning for 3BHK apartment including kitchen and bathrooms. Need professional service with eco-friendly products. All rooms need to be thoroughly cleaned, including windows and balcony.",
   status: "OPEN",
   category: "Cleaning",
   images: [],
   urgency: "normal",
                     ...
                     <div className="mb-4">
                        <div className="flex items-center">
                           ...
                           <div className="flex-1">
                              <p className="text-xs text-gray-600 uppercase mb-0.5">
                                 Posted by
                              </p>
                     ...
                     <div className="mb-5">
                        ...
                        <div className="flex overflow-x-auto gap-2.5 scrollbar-hide">
                           {taskData.images.map((image, index) => (
                              <div
                                 key={index}
                                 className="flex-shrink-0 w-24 h-24 bg-gray-200 rounded-lg flex items-center justify-center"
                              >
                     ...
                     <div className="bg-blue-50 p-4 rounded-xl mb-5 border border-blue-200">
                        ...
                        <p className="text-xs text-blue-700 capitalize">
                           ...
                           <span className="font-semibold">
                              {taskData.trackingStatus.replace("_", " ")}
                           </span>
                        </p>
               ...
               <div className="p-5 border-t border-gray-200">
                  <div className="flex items-center mb-4">
                     ...
                     <p className="text-xs text-gray-600 flex-1">
                        These messages are public and can be seen by anyone. Do
                        not share your personal info.
                     </p>
                  </div>
   ...
   return (
      <div className="flex flex-col min-h-screen bg-white">
         ...
         <div className="flex items-center justify-between px-16 pt-8 pb-8 border-b border-gray-200">
            ...
            <h1 className="text-2xl font-bold text-black flex-1 text-center">
               Task Details
            </h1>
            <button className="w-10 h-10 flex items-center justify-center">
               <span className="text-xl text-gray-600">📤</span>
            ...
            <div className="max-w-[800px] mx-auto px-16 py-16">
               ...
               <div className="flex gap-8 mb-8">
                     ...
                     <div className="bg-gray-50 p-5 rounded-2xl mb-5">
                        ...
                        <div className="mb-4">
                           <div className="flex items-center">
                              ...
                              <div className="flex-1">
                                 <p className="text-sm text-gray-600 uppercase mb-0.5">
                                    Posted by
                                 </p>
                        ...
                        <div className="mb-5">
                           ...
                           <div className="flex gap-4">
                              {taskData.images.map((image, index) => (
                                 <div
                                    key={index}
                                    className="flex-1 aspect-square bg-gray-200 rounded-xl flex items-center justify-center"
                                 >
                  ...
                  <div className="flex-1">
                     {/* Price Card */}
                     <div className="bg-gray-50 p-5 rounded-2xl mb-5">
                        <p className="text-xs text-gray-600 uppercase mb-2.5">
                           Task Budget
                        </p>
                        <p
            ...
            <div className="p-8 border-t border-gray-200">
               <div className="flex items-center mb-5">
                  ...
                  <p className="text-sm text-gray-600 flex-1">
                     These messages are public and can be seen by anyone. Do not
