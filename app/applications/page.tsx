...
const mockApplications = [
  {
    ...
    status: 'pending',
    coverLetter: 'I have 5 years of experience in deep cleaning. I use eco-friendly products and can complete the task within 4 hours.',
  ...
  },
  {
    ...
    status: 'accepted',
    coverLetter: 'Can fix this today itself. I have all the necessary tools and 10 years of experience.',
    createdAt: new Date(Date.now() - 86400000).toISOString(),
    respondedAt: new Date(Date.now() - 43200000).toISOString(),
    messages: [
      { text: 'Great! When can you start?', fromOwner: true },
    ],
  },
  {
    _id: '3',
    ...
    status: 'rejected',
    coverLetter: 'Available for weekly maintenance. I specialize in organic gardening.',
...
export default function ApplicationsPage() {
  ...
  const handleStartChat = (taskId: string, taskTitle: string, otherUserId: string) => {
    router.push(`/chat?taskId=${taskId}&taskTitle=${encodeURIComponent(taskTitle)}&otherUserId=${otherUserId}`);
  };
  ...
  const handleWithdraw = (applicationId: string) => {
    if (confirm('Are you sure you want to withdraw this application?')) {
      alert('Application withdrawal functionality will be available soon. (Mock)');
    }
  };
      ...
      <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-base text-gray-600">Loading your applications...</p>
          </div>
        </div>
        <Footer />
      </div>
      ...
      <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <div className="flex-1 flex flex-col items-center justify-center py-20 px-4">
          ...
          <p className="text-base text-gray-600 text-center leading-6 mb-6">
            You haven't applied to any tasks yet. Browse available tasks and apply to get started!
          </p>
          <button
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="space-y-4">
          {mockApplications.map((application) => {
            ...
            const proposedBudget = application.proposedBudget?.amount || 0;
              ...
              >
                ...
                >
                  ...
                  <div className="space-y-2 mb-3">
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600 font-medium">Your Proposal:</span>
                  ...
                  {application.messages && application.messages.length > 0 && (
                    <div className="mb-3 p-2 bg-blue-50 rounded">
                      <p className="text-xs text-blue-700 font-semibold">
                        💬 {application.messages.length} message(s) from task owner
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="flex gap-2 pt-3 border-t border-gray-200">
                  ...
                  {application.status === 'accepted' && (
                    <>
                      <button
                        onClick={() => handleTrackProgress(task._id)}
                      ...
                      <button
                        onClick={() => handleStartChat(task._id, taskTitle, task.requesterId)}
                        className="flex-1 py-2.5 px-4 rounded-lg text-sm font-semibold text-white"
