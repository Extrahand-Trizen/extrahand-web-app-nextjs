...
const mockApplications = [
   {
      ...
      coverLetter:
         "I have 5 years of experience in deep cleaning. I use eco-friendly products and can complete the task within 4 hours. Available this weekend.",
      relevantExperience: [
         "5 years cleaning experience",
   ...
   },
   {
      ...
      coverLetter:
         "Professional cleaning service with 10 years of experience. I bring all equipment and supplies. Can start immediately.",
      relevantExperience: [
         "10 years professional cleaning",
   ...
   },
   {
      ...
      coverLetter:
         "Experienced cleaner specializing in deep cleaning. Available weekdays.",
         ...
         <div className="flex flex-col min-h-screen bg-gray-50">
            ...
            <div className="flex-1 flex flex-col items-center justify-center py-20 px-4">
               ...
               <p className="text-base text-gray-600 text-center leading-6 mb-6">
                  No one has applied to this task yet. Share your task or wait
                  for interested performers to apply.
               </p>
               <button
                  onClick={() => router.back()}
            ...
            <div className="space-y-4">
               {mockApplications.map((application) => {
                  ...
                  const applicantRating =
                     application.applicantProfile?.rating || 0;
                  const applicantReviews =
                     application.applicantProfile?.totalReviews || 0;
