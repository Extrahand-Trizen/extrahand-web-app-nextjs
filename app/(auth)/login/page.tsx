...
export default function LoginPage() {
   ...
   const handleForgotPassword = () => {
      ...
      alert(
         "Password reset functionality will be available when API is connected."
      );
   };
   ...
   if (isMobileView) {
      return (
         <div className="min-h-screen bg-white p-6">
            ...
            <Button onClick={handleLogin} className="mb-6 w-full">
               Login
            </Button>
            ...
            <div className="text-center">
               <p className="text-sm text-secondary-700">
                  ...
                  <Link
                     href="/signup"
                     className="text-info-500 font-bold underline"
                  >
                     Sign Up
                  </Link>
               </p>
   ...
   return (
      <div className="min-h-screen bg-white flex items-center justify-center p-6">
         <Card className="w-full max-w-[480px] p-6 shadow-lg">
            <h1 className="text-2xl font-bold text-secondary-900 mb-1 text-center">
               Sign In
            </h1>
            <p className="text-sm text-secondary-500 mb-8 text-center">
               Login to your account
            </p>
