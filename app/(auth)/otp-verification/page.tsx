  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <Card padding="lg" shadow="lg" className="w-full max-w-[480px]">
        <h1 className="text-2xl font-bold text-secondary-900 mb-1 text-center">Verify Phone</h1>
        <p className="text-sm text-secondary-500 mb-2 text-center">
          {currentPhone ? `Enter the code sent to ${maskPhone(currentPhone)}` : 'Phone verification is optional'}
        </p>
