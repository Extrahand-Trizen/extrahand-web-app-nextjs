...
const mockMyTasks = [
   {
      ...
      description:
         "Weekly garden maintenance and watering for residential property",
   ...
   },
   {
      ...
      description:
         "Assemble IKEA furniture - 2 chairs and 1 table. Need professional help.",
   ...
   },
   {
      ...
      description:
         "Complete deep cleaning for 3BHK apartment including kitchen and bathrooms",
      ...
      <div className="flex-1 bg-gray-50">
         ...
         <div className="bg-white px-4 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600">
               {mockMyTasks.length} tasks posted
            </p>
         </div>
               ...
               >
                  ...
                  >
                     ...
                     <div className="space-y-2 mb-4">
                        ...
                        <div className="flex items-center justify-between">
                           ...
                           <span className="text-sm text-gray-900 font-semibold">
                               {!task.location?.address ? "Remote" : task.location.city || "N/A"}
                           </span>
                        </div>
                        <div className="flex items-center justify-between">
                           <span className="text-sm text-gray-600 font-medium">
                  ...
                  <div className="flex gap-3 pt-4 border-t border-gray-200">
                     ...
                     {task.status === "open" ? (
                        ...
                        <button
                           onClick={() =>
                              router.push(`/tasks/${task._id}/track`)
                           }
                           className="flex-1 py-2.5 px-4 rounded-lg text-sm font-semibold text-white"
