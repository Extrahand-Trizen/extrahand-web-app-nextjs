...
const mockTasks = [
  {
    ...
    description: 'Need deep cleaning for 3BHK apartment. All rooms including kitchen and bathrooms.',
  ...
  },
  {
    ...
    description: 'Install new ceiling fan in living room. Need certified electrician.',
  ...
  if (loading) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-gray-50">
        ...
        <p className="mt-4 text-base text-gray-600">Loading available tasks...</p>
      </div>
    );
  }
  ...
  if (mockTasks.length === 0) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-gray-50 py-20 px-10">
        <p className="text-2xl font-bold text-gray-900 mb-4">No Available Tasks</p>
  ...
  return (
    <div className="flex-1 bg-gray-50">
      ...
      <div className="bg-white px-4 py-4 border-b border-gray-200">
        <h2 className="text-2xl font-bold text-gray-900 mb-1">Available Tasks</h2>
        <p className="text-sm text-gray-600">{mockTasks.length} tasks available</p>
      </div>
            ...
            >
              ...
              >
                ...
                <div className="flex items-start justify-between mb-2">
                  ...
                  <span className="text-base font-bold" style={{ color: '#2196F3' }}>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                  ...
                  <span className="text-xs text-gray-400">
                    {task.createdAt ? new Date(task.createdAt).toLocaleDateString() : 'Date not available'}
                  </span>
                </div>
              </div>
              ...
              {!isMyTask && task.status === 'open' && (
                <>
                  {hasApplied ? (
                    ...
                    >
                      <span className="text-white text-xs font-bold">APPLIED</span>
                    </div>
                  ) : (
                    <button
              ...
              {isMyTask && (
                ...
                >
                  <span className="text-white text-xs font-bold">YOUR TASK</span>
                </div>
              )}
            </div>
          );
