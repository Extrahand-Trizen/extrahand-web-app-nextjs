...
export function StatusUpdateSection({
   ...
   const handleStartTaskWithOtp = async () => {
      ...
      try {
         ...
         toast.success(`OTP sent to the poster's email and in-app${result.sentTo ? ` (${result.sentTo})` : ''}. Ask the poster to check their email and app notifications.`);
      } catch (error: unknown) {
   ...
   const handleResendOtp = async () => {
      ...
      try {
         ...
         setOtpExpiresAt(result.expiresAt);
         toast.success(`OTP resent to the poster's email and in-app${result.sentTo ? ` (${result.sentTo})` : ''}`);
      } catch (error: unknown) {
