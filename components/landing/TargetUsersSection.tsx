...
const taskTypes = [
   ...
   {
      title: "Movers",
      description: "Packing, wrapping, moving",
      image: "/assets/mobilescreens/moving.png",
   },
   {
      title: "Cleaning",
      description: "Clean, mop and tidy",
   ...
   {
      title: "Deliveries",
      description: "Urgent deliveries and couriers",
...
const ScrollingGrid: React.FC<{ height: number; isMobile: boolean }> = ({
   height,
   isMobile,
}) => {
