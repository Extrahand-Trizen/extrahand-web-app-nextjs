   ...
   return (
      <section className="py-20 bg-secondary-900 relative overflow-hidden">
         ...
         <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            {/* Subtext */}
            <p className="text-lg sm:text-xl text-secondary-300 max-w-2xl mx-auto mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
               <Link href="/tasks/new">
                  <Button
                     size="lg"
                     className="bg-primary-500 hover:bg-primary-400 text-secondary-900 font-bold text-lg px-10 py-6 rounded-xl shadow-lg shadow-primary-500/25 transition-all hover:shadow-xl hover:-translate-y-0.5 w-full sm:w-auto"
                  >
                     Post a Task Now
