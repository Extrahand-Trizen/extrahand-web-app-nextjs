...
const benefits = [
   {
      ...
      description:
         "No more expensive trips or wasted time. Get things done without leaving your location.",
   },
   {
      icon: (
         <svg
      ...
      description:
         "All task performers are background-checked and verified with real reviews from users.",
   },
   {
      icon: (
         <svg
      ...
      description:
         "From router setup to grocery pickup, our network handles any type of task you need.",
   },
   {
      icon: (
         <svg
      ...
      description:
         "Smart location-based matching ensures you get the fastest and most reliable service.",
   },
   {
      icon: (
         <svg
      ...
      description:
         "Post tasks when you need help, or earn money by completing tasks in your area.",
   },
   {
      icon: (
         <svg
      ...
      description:
         "Thousands of tasks completed with a 98%+ satisfaction rate.",
   },
];
         ...
         <div className="max-w-[1200px] mx-auto px-6">
            <div className="text-center mb-12">
               ...
               <p className="text-xl text-secondary-500/80 max-w-[700px] mx-auto font-sans">
                  We've built the most reliable platform for remote task
                  delegation, designed with trust, efficiency, and user
               ...
               {benefits.map((feature, idx) => (
                  ...
                  >
                     <div className="flex items-center gap-4 mb-4">
                        ...
                        <h3 className="text-2xl font-extrabold text-secondary-900 font-sans">
                           {feature.title}
                        </h3>
                     </div>
                     <p className="text-base text-secondary-700 font-sans leading-relaxed">
                        {feature.description}
                     </p>
                  </Card>
               ))}
