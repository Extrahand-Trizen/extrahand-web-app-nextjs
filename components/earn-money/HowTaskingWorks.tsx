            ...
            <div className="relative">
               ...
               <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                  {steps.map((step, index) => (
                     ...
                     >
                        <div className="relative z-10 w-20 h-20 rounded-2xl bg-linear-to-br from-primary-400 to-primary-600 flex items-center justify-center mb-6 shadow-xl shadow-primary-500/30 group-hover:scale-110 transition-transform duration-300">
                           <step.icon className="w-9 h-9 text-white" />
                           <span className="absolute -top-3 -right-3 w-8 h-8 bg-secondary-900 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg">
                              {index + 1}
                           </span>
                        </div>
