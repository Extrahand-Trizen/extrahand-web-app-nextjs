...
export default function CookieConsentBanner() {
   ...
   return (
      <>
         {isVisible && (
            <div className="fixed inset-x-2 bottom-2 z-120 sm:inset-x-auto sm:bottom-4 sm:right-4 sm:w-[calc(100%-2rem)] sm:max-w-[640px]">
                        ...
                        <div className="min-w-0 flex-1">
                           ...
                           <div className="flex items-start justify-between gap-2 sm:gap-3">
                              <div className="min-w-0 pr-1">
                                 <h2 className="mt-0.5 text-xl font-semibold tracking-tight text-secondary-900 sm:text-2xl">
                           ...
                           <div className="mt-4 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                              <Button
                                 ...
                                 className="h-9 w-full justify-start px-0 text-base font-semibold text-secondary-900 hover:bg-transparent hover:text-secondary-800 md:w-auto"
                              >
                              ...
                              <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 md:w-auto">
                                 <Button
                                    ...
                                    className="h-10 rounded-full bg-primary-500 px-4 text-sm font-semibold text-secondary-900 hover:bg-primary-400 sm:px-5"
                                 >
                                 ...
                                 <Button
                                    type="button"
                                    onClick={handleRejectNonEssential}
                                    className="h-10 rounded-full border border-primary-500 bg-primary-100 px-4 text-sm font-semibold text-secondary-900 hover:bg-primary-200 sm:px-5"
                                 >
                                    Essential Only
                                 </Button>
                              </div>
